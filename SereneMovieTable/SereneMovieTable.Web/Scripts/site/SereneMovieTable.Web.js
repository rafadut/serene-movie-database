var SereneMovieTable;
(function (SereneMovieTable) {
    var Administration;
    ...
    })(Administration = SereneMovieTable.Administration || (SereneMovieTable.Administration = {}));
})(SereneMovieTable || (SereneMovieTable = {}));
var SereneMovieTable;
(function (SereneMovieTable) {
    var Administration;
    (function (Administration) {
...
(function (SereneMovieTable) {
    ...
    })(BasicSamples = SereneMovieTable.BasicSamples || (SereneMovieTable.BasicSamples = {}));
})(SereneMovieTable || (SereneMovieTable = {}));
var SereneMovieTable;
(function (SereneMovieTable) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = SereneMovieTable.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = SereneMovieTable.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = SereneMovieTable.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (SereneMovieTable) {
    ...
    })(Common = SereneMovieTable.Common || (SereneMovieTable.Common = {}));
})(SereneMovieTable || (SereneMovieTable = {}));
var SereneMovieTable;
(function (SereneMovieTable) {
    var Common;
...
(function (SereneMovieTable) {
    ...
    })(Membership = SereneMovieTable.Membership || (SereneMovieTable.Membership = {}));
})(SereneMovieTable || (SereneMovieTable = {}));
var SereneMovieTable;
(function (SereneMovieTable) {
    var Membership;
...
(function (SereneMovieTable) {
    ...
    })(Northwind = SereneMovieTable.Northwind || (SereneMovieTable.Northwind = {}));
})(SereneMovieTable || (SereneMovieTable = {}));
var SereneMovieTable;
(function (SereneMovieTable) {
    var Northwind;
...
(function (SereneMovieTable) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'SereneMovieTable.Northwind.Gender', 'SereneMovieTable.Northwind.Entities.Gender');
    })(Northwind = SereneMovieTable.Northwind || (SereneMovieTable.Northwind = {}));
})(SereneMovieTable || (SereneMovieTable = {}));
var SereneMovieTable;
(function (SereneMovieTable) {
...
(function (SereneMovieTable) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'SereneMovieTable.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = SereneMovieTable.Northwind || (SereneMovieTable.Northwind = {}));
})(SereneMovieTable || (SereneMovieTable = {}));
var SereneMovieTable;
(function (SereneMovieTable) {
...
(function (SereneMovieTable) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = SereneMovieTable.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = SereneMovieTable.LanguageList || (SereneMovieTable.LanguageList = {}));
})(SereneMovieTable || (SereneMovieTable = {}));
...
(function (SereneMovieTable) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = SereneMovieTable.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = SereneMovieTable.ScriptInitialization || (SereneMovieTable.ScriptInitialization = {}));
})(SereneMovieTable || (SereneMovieTable = {}));
var SereneMovieTable;
(function (SereneMovieTable) {
    var Administration;
...
(function (SereneMovieTable) {
    ...
    SereneMovieTable.BasicProgressDialog = BasicProgressDialog;
})(SereneMovieTable || (SereneMovieTable = {}));
var SereneMovieTable;
(function (SereneMovieTable) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new SereneMovieTable.BasicProgressDialog();
...
(function (SereneMovieTable) {
    ...
    })(DialogUtils = SereneMovieTable.DialogUtils || (SereneMovieTable.DialogUtils = {}));
})(SereneMovieTable || (SereneMovieTable = {}));
var SereneMovieTable;
(function (SereneMovieTable) {
    var Common;
...
(function (SereneMovieTable) {
    ...
    SereneMovieTable.StaticTextBlock = StaticTextBlock;
})(SereneMovieTable || (SereneMovieTable = {}));
var SereneMovieTable;
(function (SereneMovieTable) {
    var Common;
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                SereneMovieTable.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(SereneMovieTable.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(SereneMovieTable.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(SereneMovieTable.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        SereneMovieTable.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: SereneMovieTable.Authorization.userDefinition.DisplayName,
...
(function (SereneMovieTable) {
    ...
    (function (Northwind) {
        ...
        }(SereneMovieTable.Common.GridEditorDialog));
...
(function (SereneMovieTable) {
    ...
    (function (Northwind) {
        ...
        }(SereneMovieTable.Common.GridEditorBase));
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return SereneMovieTable.LanguageList.getValue();
            };
...
(function (SereneMovieTable) {
    ...
    })(Authorization = SereneMovieTable.Authorization || (SereneMovieTable.Authorization = {}));
})(SereneMovieTable || (SereneMovieTable = {}));
var SereneMovieTable;
(function (SereneMovieTable) {
    var BasicSamples;
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneMovieTable.Northwind.ProductDialog));
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneMovieTable.Northwind.ProductGrid));
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: SereneMovieTable.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: SereneMovieTable.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new SereneMovieTable.Northwind.OrderDialog();
                        ...
                        var chai = SereneMovieTable.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = SereneMovieTable.Northwind.EmployeeRow.getLookup().items
        ...
        }(SereneMovieTable.Northwind.OrderGrid));
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneMovieTable.Northwind.OrderDialog));
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    SereneMovieTable.Northwind.CategoryService.Retrieve({
        ...
        }(SereneMovieTable.Northwind.CategoryDialog));
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneMovieTable.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(SereneMovieTable.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new SereneMovieTable.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                SereneMovieTable.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(SereneMovieTable.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    SereneMovieTable.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(SereneMovieTable.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(SereneMovieTable.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    SereneMovieTable.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return SereneMovieTable.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return SereneMovieTable.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return SereneMovieTable.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return SereneMovieTable.Northwind.OrderService.baseUrl; };
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneMovieTable.Northwind.SupplierDialog));
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(SereneMovieTable.Northwind.SupplierGrid));
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return SereneMovieTable.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return SereneMovieTable.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return SereneMovieTable.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return SereneMovieTable.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return SereneMovieTable.Northwind.OrderService.baseUrl; };
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    SereneMovieTable.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(SereneMovieTable.Northwind.CustomerDialog));
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneMovieTable.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = SereneMovieTable.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return SereneMovieTable.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return SereneMovieTable.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new SereneMovieTable.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(SereneMovieTable.Northwind.OrderDetailDialog));
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneMovieTable.Northwind.OrderDetailsEditor));
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return SereneMovieTable.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return SereneMovieTable.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return SereneMovieTable.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return SereneMovieTable.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return SereneMovieTable.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneMovieTable.Common.BulkServiceAction));
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return SereneMovieTable.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return SereneMovieTable.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return SereneMovieTable.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return SereneMovieTable.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(SereneMovieTable.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new SereneMovieTable.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new SereneMovieTable.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new SereneMovieTable.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (SereneMovieTable) {
    ...
    SereneMovieTable.SelectableEntityGrid = SelectableEntityGrid;
})(SereneMovieTable || (SereneMovieTable = {}));
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return SereneMovieTable.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return SereneMovieTable.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return SereneMovieTable.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return SereneMovieTable.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(SereneMovieTable.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = SereneMovieTable.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            SereneMovieTable.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return SereneMovieTable.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return SereneMovieTable.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return SereneMovieTable.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return SereneMovieTable.Northwind.ProductService.baseUrl; };
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return SereneMovieTable.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return SereneMovieTable.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return SereneMovieTable.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return SereneMovieTable.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return SereneMovieTable.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return SereneMovieTable.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (SereneMovieTable) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return SereneMovieTable.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return SereneMovieTable.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return SereneMovieTable.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=SereneMovieTable.Web.js.map